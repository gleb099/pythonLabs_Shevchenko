...
def start_message(message):
    ...
    bot.send_message(message.from_user.id,
                     f'Приветствую, {message.from_user.first_name}! \nМеня зовут Туров! И я помогу тебе в выборе твоего идеального путешествия!',
...
def start_message(message):
    ...
    bot.send_message(message.from_user.id, f'До скорой встречи, {message.from_user.first_name}',
...
def get_text_messages(message):
    if message.text == 'Все туры':
        ...
        url_button = types.InlineKeyboardButton(text="Буду рад увидеть тебя на нашем сайте",
                                                url="https://www.bontour.ru/tours/europe/")
        ...
        msg = bot.send_message(message.chat.id,
                               f'{message.from_user.first_name} {message.from_user.last_name}, оставь свой номер телефона и с тобой скоро созвонится наш оператор!')
...
def phone_num(message):
    ...
    print("Номер ", number)
    msg = bot.send_message(message.chat.id,
                           f'{message.from_user.first_name}, напиши еще тур, который тебе больше всего интересен.')
...
def final(message):
    ...
    clientData[f'{message.from_user.first_name} {message.from_user.last_name} {message.from_user.username}'].append(
        number)
    clientData[f'{message.from_user.first_name} {message.from_user.last_name} {message.from_user.username}'].append(
        tour)
